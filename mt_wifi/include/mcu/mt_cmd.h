...
#if defined(MT7626)
#define EFUSE_CONTENT_END 0x3EF
#else
...
#ifdef MT7626
typedef enum _CAL_CTRL_FUNC_TYPE {
	CAL_CTRL_FUNC_DUMP_CAL_STATE = 0,
	CAL_CTRL_FUNC_DUMP_REK,
	CAL_CTRL_FUNC_DO_CAL,
	CAL_CTRL_FUNC_DO_REK,
	CAL_CTRL_FUNC_NUM
} CAL_CTRL_FUNC_TYPE;

typedef struct GNU_PACKED _CAL_CTRL_FUNC_T {
	UINT8 u1DbdcIdx;
	UINT8 u1FuncIdx;
	UINT8 aucReserve[2];
	UINT32 u4CalIdx;
} CAL_CTRL_FUNC_T, *P_CAL_CTRL_FUNC_T;
#endif
...
#ifdef MT7626
INT32 MtCmdCalCtrl(struct _RTMP_ADAPTER *pAd, INT32 BandIdx, INT32 CalFuncIdx, UINT32 CalItemIdx);
#endif
