...
#ifdef MT7626_E2_SUPPORT
#define GET_RX2_RING_SIZE(_chipCap)    ((_chipCap)->rx2_ring_size)
#define GET_RX3_RING_SIZE(_chipCap)    ((_chipCap)->rx3_ring_size)
#endif
enum EFUSE_TYPE {
	EFUSE_MT,
	EFUSE_MAX,
...
#ifdef MT7626_E2_SUPPORT
	VOID (*hw_isr_md)(struct _RTMP_ADAPTER *pAd) ____cacheline_aligned;
#endif
...
#ifdef MT7626_E2_SUPPORT
	UINT16 rx2_ring_size;
	UINT16 rx3_ring_size;
#endif
