...
struct os_cookie {
	...
	RTMP_NET_TASK_STRUCT rx_done_task[4];
#else
...
IRQ_HANDLE_TYPE
#if (KERNEL_VERSION(2, 6, 19) <= LINUX_VERSION_CODE)
rt2860_interrupt_irq_md(int irq, void *dev_instance);
#else
rt2860_interrupt_irq_md(int irq, void *dev_instance, struct pt_regs *regs);
#endif
#endif
#endif /* RTMP_MAC_PCI */
