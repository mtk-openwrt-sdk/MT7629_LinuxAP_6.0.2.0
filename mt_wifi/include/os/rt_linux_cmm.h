...
#define RTMP_OS_TASKLET_SCHE_LO(__pTasklet)							\
	schedule_work(__pTasklet)
...
/* FIXME:
 * in original,
 * FWDL ring defines MGMT_RING_SIZE of CELL,
 * but init the cells by CTL_RING_SIZE.
 * due to MGMT_RING_SIZE might be variant by MEMORY_OPTIMIZATION compile flag,
 * it potentially corrupt the memory.
 * TODO:
 * get a clear definition of the use of MGMT_RING_SIZE and CTL_RING_SIZE for ctrl_ring and fwdl_ring
 */
#define CTL_RING_SIZE		MGMT_RING_SIZE
