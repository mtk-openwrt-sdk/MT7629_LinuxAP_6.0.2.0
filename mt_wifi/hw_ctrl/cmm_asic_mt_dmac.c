...
UINT32 MtAsicGetRxStat(RTMP_ADAPTER *pAd, UINT type)
{
	...
	if (IS_MT7663(pAd) || IS_MT7626(pAd)) {
...
#if defined(MT7626)
			if (IS_MT7626(pAd)) {
				/* enable for reset counter */
				value = 0x00508c00;
				PHY_IO_WRITE32(pAd->hdev_ctrl, TALOS_CR_BAND0_STSCNT_EN_CTRL, value);
				PHY_IO_WRITE32(pAd->hdev_ctrl, TALOS_PHY1_CR_BAND0_STSCNT_EN_CTRL, value);
			}
#endif
			break;

#if defined(MT7626)
		case HQA_RX_STAT_RSSI_BAND1:
			PHY_IO_READ32(pAd->hdev_ctrl, TALOS_WF_RXTD_PHY1_RO_AGC_DEBUG_0_RX0_ADDR, &temp);
			/* WF0 IB RSSI */
			value |= ((temp & 0xFF000000) >> 16);
			/* WF0 WB RSSI */
			value |= ((temp & 0x00FF0000) >> 16);
			PHY_IO_READ32(pAd->hdev_ctrl, TALOS_WF_RXTD_PHY1_RO_AGC_DEBUG_0_RX1_ADDR, &temp);
			/* WF1 IB RSSI */
			value |= (temp & 0xFF000000);
			/* WF1 WB RSSI */
			value |= (temp & 0x00FF0000);
		...
		case  HQA_RX_STAT_RSSI_RX23_BAND1:
			PHY_IO_READ32(pAd->hdev_ctrl, TALOS_WF_RXTD_PHY1_RO_AGC_DEBUG_0_RX2_ADDR, &temp);
			/* WF2 IB RSSI */
			value |= ((temp & 0xFF000000) >> 16);
			/* WF2 WB RSSI */
			value |= ((temp & 0x00FF0000) >> 16);
			PHY_IO_READ32(pAd->hdev_ctrl, TALOS_WF_RXTD_PHY1_RO_AGC_DEBUG_0_RX3_ADDR, &temp);
			/* WF3 IB RSSI */
			value |= (temp & 0xFF000000);
			/* WF3 WB RSSI */
			value |= (temp & 0x00FF0000);
		...
		case HQA_RX_STAT_ACI_HITL_BAND1:
			PHY_IO_READ32(pAd->hdev_ctrl, TALOS_WF_RXTD_PHY1_RO_AGC_DEBUG_2_RX0_ADDR, &temp);
			/* WF0 ACID HIT */
			value |= ((temp & 0x00020000) << 1);
			PHY_IO_READ32(pAd->hdev_ctrl, TALOS_WF_RXTD_PHY1_RO_AGC_DEBUG_2_RX1_ADDR, &temp);
			/* WF1 ACID HIT */
			value |= (temp & 0x00020000);
			break;

		case HQA_RX_STAT_ACI_HITH_BAND1:
			PHY_IO_READ32(pAd->hdev_ctrl, TALOS_WF_RXTD_PHY1_RO_AGC_DEBUG_2_RX2_ADDR, &temp);
			/* WF2 ACID HIT */
			value |= ((temp & 0x00020000) << 1);
			PHY_IO_READ32(pAd->hdev_ctrl, TALOS_WF_RXTD_PHY1_RO_AGC_DEBUG_2_RX3_ADDR, &temp);
			/* WF3 ACID HIT */
			value |= (temp & 0x00020000);
			break;
#endif
		...
		case HQA_RX_STAT_PHY_MDRDYCNT_BAND1:
			/* [31:16] OFDM [15:0] CCK */
			PHY_IO_READ32(pAd->hdev_ctrl, TALOS_PHY1_RO_BAND0_PHYCTRL_STS1, &value);
			break;

		case HQA_RX_STAT_PHY_FCSERRCNT_BAND1:
			/* [31:16] OFDM [15:0] CCK */
			PHY_IO_READ32(pAd->hdev_ctrl, TALOS_PHY1_RO_BAND0_PHYCTRL_STS5, &value);
			break;

		case HQA_RX_STAT_PD_BAND1:
			/* [31:16] OFDM [15:0] CCK */
			PHY_IO_READ32(pAd->hdev_ctrl, TALOS_PHY1_RO_BAND0_PHYCTRL_STS0, &value);
			break;

		case HQA_RX_STAT_CCK_SIG_SFD_BAND1:
			/* [31:16] SIG [15:0] SFD */
			PHY_IO_READ32(pAd->hdev_ctrl,  TALOS_PHY1_RO_BAND0_PHYCTRL_STS3, &value);
			break;

		case HQA_RX_STAT_OFDM_SIG_TAG_BAND1:
			/* [31:16] SIG [15:0] TAG */
			PHY_IO_READ32(pAd->hdev_ctrl,  TALOS_PHY1_RO_BAND0_PHYCTRL_STS4, &value);
			break;
#endif
