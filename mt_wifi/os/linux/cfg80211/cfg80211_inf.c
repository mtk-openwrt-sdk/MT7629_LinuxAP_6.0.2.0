	...
	IN UINT32                DevType)
{
	...
	new_dev_p = RtmpOSNetDevCreate(pAd, MC_RowID, &IoctlIF, Inf, preIfIndex, sizeof(PRTMP_ADAPTER), preIfName, TRUE);
	...
	case RT_CMD_80211_IFTYPE_MONITOR:
		MTWF_LOG(DBG_CAT_INIT, DBG_SUBCAT_ALL, DBG_LVL_TRACE, ("CFG80211 I/F Monitor Type\n"));
