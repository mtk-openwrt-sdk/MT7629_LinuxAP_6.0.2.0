...
#define EEPROM_DEFAULT_FILE_PATH                     "/etc/wireless/mediatek/MT%x_EEPROM.bin"
#endif /* MT7626 */
...
#if defined(MT7626)
#define TX_PATH_NUM 3
#define RX_PATH_NUM 3
#define MAX_ANTENNA_NUM	3
#define CONNAC_WIFI_TX_POWER_EFUSE_TYPE EFUSE_INFO_TX_POWER_EXTENDED_TYPE

/* A Die EFUSE Block for 7761 & 7762  */
#define ADIE_7761_EFUSE_OFFSET   0x40
#define ADIE_7762_EFUSE_OFFSET   0x50
#define EFUSE_ADIE_MAX_NUM       2

typedef struct _EFUSE_ADIE_INFO_T {
    UINT8 ucFreqOffset;         /* 0x0 */
    UINT8 ucXtalTrim2;          /* 0x1 */
    UINT8 ucXtalTrim3;          /* 0x2 */
    UINT8 ucXtalTrim4;          /* 0x3 */
    UINT8 ucXtalTrimFlow;       /* 0x4 */

    UINT8 ucRcalResult;         /* 0x5 */

    UINT8 THADCAnalogPart;      /* 0x6 */
    UINT8 THADCSlop;            /* 0x7 */
    UINT8 TempSensorCal;        /* 0x8 */
    UINT8 ThemalCompOffset;     /* 0x9 */

    UINT8 TRXLDOVSel;           /* 0xA */

    UINT8 reserved[5];

} EFUSE_ADIE_INFO_T, *P_EFUSE_ADIE_INFO_T;
/* A Die EFUSE Block for 7761 & 7762 End */
...
#ifdef MT7626
typedef struct _EFUSE_INFO_ELEMENT_ELNA_RX_GAIN_COMP_T {
#ifdef RT_BIG_ENDIAN
	UINT8 u1Reserve		: 6;
	UINT8 u12GValid		: 1;
	UINT8 u15GValid		: 1;
	...
	UINT8 u1Reserved	: 6;
#endif
} EFUSE_INFO_ELEMENT_ELNA_RX_GAIN_COMP_T, *P_EFUSE_INFO_ELEMENT_ELNA_RX_GAIN_COMP_T;

typedef struct _EFUSE_INFO_ELEMENT_2G_RX_ELNA_GAIN_DELTA_T {
#ifdef RT_BIG_ENDIAN
	UINT8 u1RX0ELNAGainDeltaH		: 4;
	UINT8 u1RX0ELNAGainDeltaUH		: 4;

	UINT8 u1RX0ELNAGainDeltaL		: 4;
	UINT8 u1RX0ELNAGainDeltaM		: 4;

	UINT8 u1RX1ELNAGainDeltaUH		: 4;
	UINT8 u1RX0ELNAGainDeltaUL		: 4;

	UINT8 u1RX1ELNAGainDeltaM		: 4;
	UINT8 u1RX1ELNAGainDeltaH		: 4;

	UINT8 u1RX1ELNAGainDeltaUL		: 4;
	UINT8 u1RX1ELNAGainDeltaL		: 4;

	UINT8 u1RX2ELNAGainDeltaH		: 4;
	UINT8 u1RX2ELNAGainDeltaUH		: 4;

	UINT8 u1RX2ELNAGainDeltaL		: 4;
	UINT8 u1RX2ELNAGainDeltaM		: 4;

	UINT8 u1Reserved				: 4;
	UINT8 u1RX2ELNAGainDeltaUL		: 4;
#else
	UINT8 u1RX0ELNAGainDeltaUH		: 4;
	UINT8 u1RX0ELNAGainDeltaH		: 4;
	...
	UINT8 u1Reserved				: 4;
#endif
} EFUSE_INFO_ELEMENT_2G_RX_ELNA_GAIN_DELTA_T, *P_EFUSE_INFO_ELEMENT_2G_RX_ELNA_GAIN_DELTA_T;

typedef struct _EFUSE_INFO_ELEMENT_5G_RX_ELNA_GAIN_DELTA_T {
#ifdef RT_BIG_ENDIAN
	UINT8 u1G0ELNAGainDeltaH		: 4;
	UINT8 u1G0ELNAGainDeltaUH		: 4;

	UINT8 u1G0ELNAGainDeltaL		: 4;
	UINT8 u1G0ELNAGainDeltaM		: 4;

	UINT8 u1G1ELNAGainDeltaUH		: 4;
	UINT8 u1G0ELNAGainDeltaUL		: 4;

	UINT8 u1G1ELNAGainDeltaM		: 4;
	UINT8 u1G1ELNAGainDeltaH		: 4;

	UINT8 u1G1ELNAGainDeltaUL		: 4;
	UINT8 u1G1ELNAGainDeltaL		: 4;
#else
	UINT8 u1G0ELNAGainDeltaUH		: 4;
	UINT8 u1G0ELNAGainDeltaH		: 4;
	...
	UINT8 u1G1ELNAGainDeltaUL		: 4;
#endif
} EFUSE_INFO_ELEMENT_5G_RX_ELNA_GAIN_DELTA_T, *P_EFUSE_INFO_ELEMENT_5G_RX_ELNA_GAIN_DELTA_T;
#endif
...
#ifdef MT7626
	EFUSE_INFO_ELEMENT_5G_RX_ELNA_GAIN_DELTA_T rRxELNAGainDelta[A_BAND_CH_GROUP_NUM/2];
#else
