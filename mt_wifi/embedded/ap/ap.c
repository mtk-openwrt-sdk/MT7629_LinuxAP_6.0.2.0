...
#ifdef DYNAMIC_STEERING_LOADING
		if (arch_ops && arch_ops->arch_combo_tx_rps_algo)
			arch_ops->arch_combo_tx_rps_algo(pAd);
...
#ifdef DYNAMIC_STEERING_LOADING
		if (ad->disable_auto_txop == 1)
			goto ignore_ampdu_efficiency_check2;
#endif
...
#ifdef DYNAMIC_STEERING_LOADING
ignore_ampdu_efficiency_check2:
#endif
