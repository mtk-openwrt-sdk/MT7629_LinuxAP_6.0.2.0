...
#ifdef MT7626
	/* MT7626 CCK Rate on 5G Counter */
	{"cckcount",			ShowCCKCountProc},
#endif
	{NULL,}
};
...
#if defined(MT7626)
	pAd->WlanCounters[ucBand].TxAggRange5Count.u.LowPart = 0;
	pAd->WlanCounters[ucBand].TxAggRange6Count.u.LowPart = 0;
	pAd->WlanCounters[ucBand].TxAggRange7Count.u.LowPart = 0;
	pAd->WlanCounters[ucBand].TxAggRange8Count.u.LowPart = 0;

	pAd->WlanCounters[ucBand].TxAMSDU1Count.u.LowPart = 0;
	pAd->WlanCounters[ucBand].TxAMSDU2Count.u.LowPart = 0;
	pAd->WlanCounters[ucBand].TxAMSDU3Count.u.LowPart = 0;
	pAd->WlanCounters[ucBand].TxAMSDU4Count.u.LowPart = 0;
#endif
	{
		int i, j, k, maxMcs = 15;
		PMAC_TABLE_ENTRY pEntry;
...
#if defined(MT7626)
	sprintf(msg + strlen(msg), "TX AGG Range 4 (16~22)          = %ld\n", (LONG)(WlanCounter->TxAggRange4Count.u.LowPart));
	sprintf(msg + strlen(msg), "TX AGG Range 5 (23~33)          = %ld\n", (LONG)(WlanCounter->TxAggRange5Count.u.LowPart));
	sprintf(msg + strlen(msg), "TX AGG Range 6 (34~49)          = %ld\n", (LONG)(WlanCounter->TxAggRange6Count.u.LowPart));
	sprintf(msg + strlen(msg), "TX AGG Range 7 (50~57)          = %ld\n", (LONG)(WlanCounter->TxAggRange7Count.u.LowPart));
	sprintf(msg + strlen(msg), "TX AGG Range 8 (58~64)          = %ld\n", (LONG)(WlanCounter->TxAggRange8Count.u.LowPart));

	if (BandIdx == 0) {
		COUNTER_802_11 *WlanCounter1 = &pAd->WlanCounters[1];
		sprintf(msg + strlen(msg), "TX AMSDU 1                      = %ld\n", (LONG)(WlanCounter->TxAMSDU1Count.u.LowPart+WlanCounter1->TxAMSDU1Count.u.LowPart));
		sprintf(msg + strlen(msg), "TX AMSDU 2                      = %ld\n", (LONG)(WlanCounter->TxAMSDU2Count.u.LowPart+WlanCounter1->TxAMSDU2Count.u.LowPart));
		sprintf(msg + strlen(msg), "TX AMSDU 3                      = %ld\n", (LONG)(WlanCounter->TxAMSDU3Count.u.LowPart+WlanCounter1->TxAMSDU3Count.u.LowPart));
		sprintf(msg + strlen(msg), "TX AMSDU 4(>4)                  = %ld\n", (LONG)(WlanCounter->TxAMSDU4Count.u.LowPart+WlanCounter1->TxAMSDU4Count.u.LowPart));
	} else {
		COUNTER_802_11 *WlanCounter1 = &pAd->WlanCounters[0];
		sprintf(msg + strlen(msg), "TX AMSDU 1                      = %ld\n", (LONG)(WlanCounter->TxAMSDU1Count.u.LowPart+WlanCounter1->TxAMSDU1Count.u.LowPart));
		sprintf(msg + strlen(msg), "TX AMSDU 2                      = %ld\n", (LONG)(WlanCounter->TxAMSDU2Count.u.LowPart+WlanCounter1->TxAMSDU2Count.u.LowPart));
		sprintf(msg + strlen(msg), "TX AMSDU 3                      = %ld\n", (LONG)(WlanCounter->TxAMSDU3Count.u.LowPart+WlanCounter1->TxAMSDU3Count.u.LowPart));
		sprintf(msg + strlen(msg), "TX AMSDU 4(>4)                  = %ld\n", (LONG)(WlanCounter->TxAMSDU4Count.u.LowPart+WlanCounter1->TxAMSDU4Count.u.LowPart));
