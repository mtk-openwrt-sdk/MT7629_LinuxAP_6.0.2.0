	...
	if ((prRadarReport->lng_pls_detected == 1) || (prd_radar_detected == TRUE) || (sw_rdd_log_cond == FALSE)) {
		...
		if (prd_radar_detected == TRUE) {
			...
			MTWF_LOG(DBG_CAT_PROTO, CATPROTO_DFS, DBG_LVL_OFF,
				...
				pAd->CommonCfg.DfsParameter.sw_radar_type[rt_idx].rt_crpn_min,
				pAd->CommonCfg.DfsParameter.sw_radar_type[rt_idx].rt_crpn_max));
			MTWF_LOG(DBG_CAT_PROTO, CATPROTO_DFS, DBG_LVL_OFF,
				("CRPR = %d/%d \t(RT_CRPR_MIN = %d/%d)\n",
				prRadarReport->out_crpn,
				prRadarReport->prd_pls_num,
				pAd->CommonCfg.DfsParameter.sw_radar_type[rt_idx].rt_crpr_min, PPB_SIZE));
			MTWF_LOG(DBG_CAT_PROTO, CATPROTO_DFS, DBG_LVL_OFF,
				("CRPW = %d \t(RT_PW_MIN = %d, RT_PW_MAX = %d)\n",
				prRadarReport->out_crpw,
				pAd->CommonCfg.DfsParameter.sw_radar_type[rt_idx].rt_pw_min,
				pAd->CommonCfg.DfsParameter.sw_radar_type[rt_idx].rt_pw_max));
			MTWF_LOG(DBG_CAT_PROTO, CATPROTO_DFS, DBG_LVL_OFF,
				("PRI_CONST = %d \t(RT_PRI_MIN = %d, RT_PRI_MAX = %d)\n",
				prRadarReport->out_pri_const,
				pAd->CommonCfg.DfsParameter.sw_radar_type[rt_idx].rt_pri_min,
				pAd->CommonCfg.DfsParameter.sw_radar_type[rt_idx].rt_pri_max));
			MTWF_LOG(DBG_CAT_PROTO, CATPROTO_DFS, DBG_LVL_OFF,
				("CRBN = %d \t(RT_CRBN_MIN = %d, RT_CRBN_MAX = %d)\n",
				prRadarReport->out_crbn,
				pAd->CommonCfg.DfsParameter.sw_radar_type[rt_idx].rt_crbn_min,
				pAd->CommonCfg.DfsParameter.sw_radar_type[rt_idx].rt_crbn_max));
			MTWF_LOG(DBG_CAT_PROTO, CATPROTO_DFS, DBG_LVL_OFF,
				("PRI_STG1 = %d \t(RT_PRI_MIN = %d, RT_PRI_MAX*3 = %d)\n",
				prRadarReport->out_pri_stg1,
				pAd->CommonCfg.DfsParameter.sw_radar_type[rt_idx].rt_pri_min,
				pAd->CommonCfg.DfsParameter.sw_radar_type[rt_idx].rt_pri_max * 3));
			MTWF_LOG(DBG_CAT_PROTO, CATPROTO_DFS, DBG_LVL_OFF,
			...
			MTWF_LOG(DBG_CAT_PROTO, CATPROTO_DFS, DBG_LVL_OFF,
				...
				pAd->CommonCfg.DfsParameter.sw_radar_type[rt_idx].rt_stg_pn_min,
				pAd->CommonCfg.DfsParameter.sw_radar_type[rt_idx].rt_stg_pn_max));
			MTWF_LOG(DBG_CAT_PROTO, CATPROTO_DFS, DBG_LVL_OFF,
				("STGPR = %d/%d \t(RT_STGPR_MIN = %d/%d)\n",
				prRadarReport->out_stg_pn,
				prRadarReport->prd_pls_num,
				pAd->CommonCfg.DfsParameter.sw_radar_type[rt_idx].rt_stg_pr_min, PPB_SIZE));
		} else {
			MTWF_LOG(DBG_CAT_PROTO, CATPROTO_DFS, DBG_LVL_OFF,
